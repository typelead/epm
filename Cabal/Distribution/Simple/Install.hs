...
--         dynlibdir  = dynlibPref, --see TODO below
  ...
  case compilerFlavor (compiler lbi) of
     ...
     ETA-> do withLibLBI pkg_descr lbi $
                  ETA.installLib verbosity lbi libPref dynlibPref buildPref pkg_descr
              withExe pkg_descr $
                  ETA.installExe verbosity lbi installDirs buildPref (progPrefixPref, progSuffixPref) pkg_descr
